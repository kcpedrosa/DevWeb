...
function carregaListaDespesas(outroArrayDespesas = Array(), filtro = false) {
	//let outroArrayDespesas = Array() [desnec, estms declr no param da funcao]
	//sendo o filtro true[E nao houver elements retornds na pesquisa] nao carrega nada
	if(outroArrayDespesas.length == 0 && filtro == false){
	...
	outroArrayDespesas.forEach( function(d){
		...
		linhatr.insertCell(4).append(btn)
...
function pesquisarDespesa() {
	...
	carregaListaDespesas(retornoDespesasConsultadas, true)
